...
static float SCPI_SamplingTimeToFloat(uint32_t sampling_time)
{
	switch (sampling_time)
	{
		case ADC_SAMPLETIME_1CYCLE_5 : return 1.5f; break;
		case ADC_SAMPLETIME_2CYCLES_5 : return 2.5f; break;
		case ADC_SAMPLETIME_8CYCLES_5 : return 8.5f; break;
		case ADC_SAMPLETIME_16CYCLES_5 : return 16.5f; break;
		case ADC_SAMPLETIME_32CYCLES_5 : return 32.5f; break;
		case ADC_SAMPLETIME_64CYCLES_5 : return 64.5f; break;
		case ADC_SAMPLETIME_387CYCLES_5 : return 387.5f; break;
		case ADC_SAMPLETIME_810CYCLES_5 : return 810.5f; break;
	}
...
{
	SCPI_ResultFloat(context, SCPI_SamplingTimeToFloat(bsp.adc.sampling_time));
	return SCPI_RES_OK;
}
